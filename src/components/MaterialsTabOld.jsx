...
export default function MaterialsTab({ courseId, lecturerId }) {
    ...
    uploadTask.on(
      ...
      async () => {
        ...
        addDoc(materialsRef, {
          ...
          console.error("Failed to save material metadata:", err)
        );
        setUploading(false);
        setUploadProgress(0);
      }
  ...
  function handleDelete(material) {
    ...
    deleteDoc(materialRef).catch((err) =>
    ...
    <div className="materials-tab">
      ...
      {uploading && (
        <div className="upload-progress">
          ...
          <p className="muted small">Uploading... {uploadProgress}%</p>
        </div>
      )}
          ...
          {materials.map((m) => (
            <div className="material-row" key={m.id}>
              ...
              <div className="material-actions">
                ...
                <button onClick={() => openRename(m)} className="link-btn">
                Rename
                </button>
                <button
